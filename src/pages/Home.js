...
const s = {
  ...
  heroBg: {
    ...
    fontFamily: 'var(--font-display)', fontSize: 'clamp(120px, 20vw, 220px)',
  ...
  trustDot: { color: 'rgba(28,43,26,0.4)', fontSize: 18 },
  // SERVICES
  ...
  formLeft: {},
  formAccent: {
    width: 40, height: 4, background: 'var(--gold)',
  ...
  directContact: {
    borderTop: '1px solid #ddd', paddingTop: '1.5rem', marginTop: '1.5rem',
  },
  ...
  areasTitle: {
    ...
    fontWeight: 800, textTransform: 'uppercase', color: 'var(--white)',
      ...
      <section style={s.servicesSection} aria-labelledby="services-heading">
        <div style={s.sectionInner}>
          ...
          <p style={s.sectionSub}>
            From footings to finish work, site clearing to septic — we handle the heavy work so your project gets done right.
          </p>
          <div style={s.servicesGrid}>
            {SERVICES.map(sv => (
              <div key={sv.title} style={s.serviceCard}
                ...
                <div style={s.serviceIcon} aria-hidden="true">{sv.icon}</div>
        ...
        <div style={s.sectionInner}>
          <div style={s.formGrid} className="form-section-grid">
            <div style={s.formLeft}>
              <div style={s.formAccent} aria-hidden="true" />
              <h2 id="quote-heading" style={s.formTitle}>
